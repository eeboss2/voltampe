...
export interface CardsRayCard extends Struct.ComponentSchema {
  ...
  attributes: {
    after_ray_items: Schema.Attribute.Component<'items.ray-card-items', false>;
    before_ray_items: Schema.Attribute.Component<'items.ray-card-items', false>;
    description: Schema.Attribute.String;
    span: Schema.Attribute.Enumeration<['one', 'two', 'three']>;
    title: Schema.Attribute.String;
  };
...
export interface ItemsRayCardItems extends Struct.ComponentSchema {
  collectionName: 'components_items_ray_card_items';
  info: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'items.ray-card-items': ItemsRayCardItems;
