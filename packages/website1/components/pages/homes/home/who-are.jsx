                    ...
                    <div className="col-xl-6 col-lg-7">
                        <div className="who__area-right">
                            <div className="who__area-right-title">
                                ...
                                <h2>Innovation in Electric Power Excellence</h2>
                            </div>
                            <div className="who__area-right-btn">
                                <ul className="nav nav-pills gap-4">
                                    ...
                                    <li className="nav-item" role="presentation">
                                      <button className="btn-two active" data-bs-toggle="pill" data-bs-target="#solar">Solution</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                            ...
                            <div className="tab-content">
                                <div className="tab-pane fade" id="technology">
                                    <div className="who__area-right-tab">
                                        <p>Prefabricated substations are a new type of integrated substation construction solution that integrates electrical equipment and auxiliary facilities using prefabricated modules. Its core feature is rapid deployment through factory production and modular assembly. It has characteristics such as small footprint, short construction period, flexible layout and cost savings, and is widely used in substation construction in various fields such as new energy, oil and petrochemical, industrial users, and urban centers.</p>
                                ...
                                <div className="tab-pane fade show active" id="solar">
                                    <div className="who__area-right-tab">
                                        <p>We offer both modular and prefabricated solutions; for exterior options, we provide corrugated and flat panel options, and for exterior wall materials, we offer both metal and non-metal options. Flexible configuration is available to suit project needs.</p>
                                        <div className="who__area-right-tab-list">
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Business Management</span>
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Business Accounting</span>
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Award Winning Company</span>
                                ...
                                <div className="tab-pane fade" id="philosophy">
                                    <div className="who__area-right-tab">
                                        <p>Providing cheap and convenient electricity to the world</p>
                                        <div className="who__area-right-tab-list">
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Business Management</span>
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Business Accounting</span>
                                            <span><i className="fa-sharp fa-solid fa-circle-check"></i>Award Winning Company</span>
