                ...
                <div className="row al-center">
                    <div className="col-lg-8">
                        <div className="topBar__one-left lg-t-center">
                            <ul>
                                <li><Link href="sales@tranliner.com"><i className="flaticon-envelope"></i>sales@tranliner.com</Link></li>
                                <li><Link href="https://google.com/maps"><i className="flaticon-placeholder"></i>A-823 Xinian Center, Yinxiu Road, Wuxi City, Jiangsu Province, CHINA</Link></li>
                            </ul>
                        </div>
                    </div>
