    ...
    return (
        <>
            <div className={`header__area-menubar-right-sidebar-popup ${addClass} ${isOpen ? 'active' : ''}`}>
				...
				<p>Leveraging China’s strong manufacturing and design capabilities, we produce and supply the world’s best rapid deployment and compact power transmission, substation, and distribution facilities and technologies.</p>
				<div className="header__area-menubar-right-sidebar-popup-contact">
					...
					<div className="header__area-menubar-right-sidebar-popup-contact-item">
						...
						<div className="header__area-menubar-right-sidebar-popup-contact-item-content">
							<span>Call Now</span>
							<h6><Link href="tel:+8613306176648">+86 133 0617 6648</Link></h6>
						</div>
					</div>
					<div className="header__area-menubar-right-sidebar-popup-contact-item">
						<div className="header__area-menubar-right-sidebar-popup-contact-item-icon">
						...
						<div className="header__area-menubar-right-sidebar-popup-contact-item-content">
							...
							<h6><Link href="mailto:sales@tranliner.com">sales@tranliner.com</Link></h6>
						</div>
					</div>
					<div className="header__area-menubar-right-sidebar-popup-contact-item">
						<div className="header__area-menubar-right-sidebar-popup-contact-item-icon">
						...
						<div className="header__area-menubar-right-sidebar-popup-contact-item-content">
							...
							<h6><Link href="https://google.com/maps" target="_blank">A-823 Xinian Center, Yinxiu Road, Wuxi City, Jiangsu Province, CHINA</Link></h6>
						</div>
					</div>
				</div>
